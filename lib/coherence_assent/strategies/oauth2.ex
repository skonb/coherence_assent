defmodule CoherenceAssent.Strategies.Oauth2 do
  ...
  defp process_user_response({:error, %OAuth2.Response{status_code: 401, body: body}}, _conn) do
    raise "Unauthorized token"
  end
  defp process_user_response({:error, %OAuth2.Error{reason: reason}}, _conn) do
