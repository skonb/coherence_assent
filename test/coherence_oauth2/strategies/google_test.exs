defmodule CoherenceOauth2.GoogleTest do
  ...
  setup do
    bypass = Bypass.open
    client = CoherenceOauth2.Google.client(site: bypass_server(bypass),
  ...
  describe "get_user/2" do
    test "normalizes data", %{client: client, bypass: bypass} do
      ...
      assert {:ok, expected} == CoherenceOauth2.Google.get_user(client)
    end
  end
end
